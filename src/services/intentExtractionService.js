...
class IntentExtractionService {
  ...
  async extractWithLlm(preprocessed, catalogEntries = []) {
    ...
    const prompt = [
      'You extract service intent for a local-services marketplace.',
      'Input may be Hindi, Hinglish, or English.',
      'Return one primary intent, one context label, a small keyword list, and profession suggestions.',
